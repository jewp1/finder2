...
SECRET_KEY = os.environ.get("SECRET_KEY", "project-finder-secret-key-2024")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "project_finder"),
        "USER": os.environ.get("POSTGRES_USER", "postgres"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "postgres"),
        "HOST": os.environ.get("POSTGRES_SERVER", os.environ.get("POSTGRES_HOST", "db")),
...
_cors_origins_env = os.environ.get("BACKEND_CORS_ORIGINS", "")
if _cors_origins_env.startswith("["):
    import json

    CORS_ALLOWED_ORIGINS = json.loads(_cors_origins_env)
...
LOGGING = {
    ...
    "handlers": {
        ...
        "logstash": {
            "class": "config.logstash_handler.TCPJsonHandler",
            "host": LOGSTASH_HOST,
            "port": LOGSTASH_PORT,
            "level": "INFO",
        },
